...
const ModelShowcaseSection = ({
  ...
  return (
    <section className="relative h-[70vh] min-h-[500px] max-h-[700px] overflow-hidden bg-background">
      ...
      <div className="relative h-full container-wj">
        <motion.div
          ...
          viewport={{ once: true }}
          className="absolute bottom-12 md:bottom-16 left-4 md:left-0 max-w-md"
        >
          {/* Model Badge */}
